...
Object.defineProperty(exports, "preloadFonts", {
  enumerable: true,
  get: function () {
    return _utils.preloadFonts;
  }
});
Object.defineProperty(exports, "preloadImages", {
  enumerable: true,
  get: function () {
    return _utils.preloadImages;
  }
});
...
function main() {
  ...
  var cubes = [makeInstance(geometry, 0x44aa88, 0, 'Aqua'), makeInstance(geometry, 0x8844aa, -2, 'Purple'), makeInstance(geometry, 0xaa8844, 2, 'Gold')];
  ...
  function render(time) {
    ...
    cubes.forEach(function (cubeInfo, ndx) {
      ...
      elem.style.transform = "translate(-50%, -50%) translate(".concat(x, "px,").concat(y, "px)");
    });
